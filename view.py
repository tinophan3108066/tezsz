...
# Chặn mọi thứ in ra stdout & stderr
@contextmanager
def suppress_output():
...
reset = '\033[0m'  # reset về bình thường
...
def spamcall4(phone, count):
    for i in range(1, count + 1):
        ...
        print(f"{color}Đã spam tới số {phone} lần thứ {i}{reset}")

if __name__ == "__main__":
    print(f"""
""")
    print(f"\033[1;31m Spam SMS ")
    phone = input("\033[1;32m Nhập số điện thoại: ")
    count = int(input("\033[1;34m Nhập số lần spam: "))
    
    colors = ['\033[91m', '\033[93m', '\033[92m', '\033[96m', '\033[94m', '\033[95m', '\033[90m']
    reset = '\033[0m'

    for i in range(1, count + 1):
        with suppress_output():  # chặn mọi dòng lỗi và in rác
            try:
                run(phone, i)
            except:
                pass  # không hiện lỗi
