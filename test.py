...
def type_effect(text, speed=0.02):  # Giảm tốc độ xuống 0.02
    colors = [Fore.RED, Fore.GREEN, Fore.YELLOW, Fore.BLUE, Fore.CYAN, Fore.MAGENTA, Fore.WHITE]
    for char in text:
        color = random.choice(colors)  # Chọn màu ngẫu nhiên cho mỗi ký tự
...
def spamcall2(phone, count):
    for i in range(1, count + 1):
        run(phone, i)

if __name__ == "__main__":
    print("\033[1;34mspamsms\033[0m")  
